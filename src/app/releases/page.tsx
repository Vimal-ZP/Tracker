...
import { Project, ReleasePlan, ReleasePlanStatus, ReleasePlanPriority, CreateReleasePlanData } from '@/types/project';
...
export default function ReleasesPage() {
  ...
  const [planFormData, setPlanFormData] = useState<Partial<CreateReleasePlanData>>({
  ...
  const handleCreateReleasePlan = async (data: CreateReleasePlanData) => {
    try {
      const response = await fetch('/api/release-plans', {
        ...
        body: JSON.stringify({
          ...data,
          assignedToId: user?._id // For now, assign to current user
        })
      });
