                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center space-x-2 mt-1">
                                                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${user.userRole === 'super_admin' ? 'bg-red-100 text-red-700' :
                                ...
                                <div className="grid grid-cols-12 gap-6 items-start">
                                    ...
                                    <div className="col-span-7">
                                        <div className="flex items-center space-x-3 mb-2">
                                            ...
                                            <span className={`text-xs px-2 py-1 rounded-full font-medium ${activity.userRole === 'super_admin' ? 'bg-red-100 text-red-700 border border-red-200' :
